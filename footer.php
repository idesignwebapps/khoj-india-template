		...
		<div id="footer-wrapper">
			...
			<section>
				...
				<div class="social-links">
					<a href="https://www.instagram.com/khoj.india.official/" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/images/instagram.png" alt="instagram logo"></a>
					<a href="https://twitter.com/khoj_india" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/images/twitter.png" alt="twitter logo"></a>
					<a href="https://www.threads.net/@khoj.india.official" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/images/threads.png" alt="threads logo"></a>
					<a href="https://www.facebook.com/profile.php?id=61550666441683" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/images/facebook.png" alt="facebook logo"></a>
				</div>
			</section>
		</div>
	</div>
	<p>All Rights Reserved &hyphen; <a href="https://www.linkedin.com/in/aditya-jain26" target="_blank">Adi Jain</a>
		&copy; 2022-2023</p>
</footer>
<!-- footer END -->
</div>
